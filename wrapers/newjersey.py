...
def main(Scraperdata, request):
    ...
    for val in EligibilityBenefits:
        ...
        if val.get("ProcedureCode") == "D2391":
            ...
            if EligibilityPatientVerification.get("AlternativeBenefitProvision") == "":
...
# data=json.load(open(r"C:\Users\iamha\Desktop\BPK teck\All Payors\SDB EXTERNAL\dev 15 june all testing\dev 17 june\SD%20Payor%20Scraping\output_230618_002446_.json", 'r'))
# output=main(data, request)
# with open("NewJerseyutOutput.json", "w") as outfile:
